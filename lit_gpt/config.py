...
Samba = [
    ...
    dict(
        org="Microsoft",
        name="LLaMA_438M_full_mamba_1,5", 
        block_size=4096,
        vocab_size=32000,
        padding_multiple=64,
        n_layer=12,
